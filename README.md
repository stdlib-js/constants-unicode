...
```javascript
import constants from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-unicode@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { MAX, MAX_BMP } from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-unicode@v0.1.0-deno/mod.js';
```
